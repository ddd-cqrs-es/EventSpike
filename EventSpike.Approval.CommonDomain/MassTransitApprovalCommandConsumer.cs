...
namespace EventSpike.Approval.CommonDomain
{
    ...
    {
        private readonly IProvideForTenant<IRepository> _repositoryProvider;

        public MassTransitApprovalCommandConsumer(IProvideForTenant<IRepository> repositoryProvider)
        {
