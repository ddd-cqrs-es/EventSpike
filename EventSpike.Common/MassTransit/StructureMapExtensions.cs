...
namespace EventSpike.Common.MassTransit
{
    public static class StructureMapExtensions
    {
        ...
        public static void LoadFromWithContext(this SubscriptionBusServiceConfigurator configurator, IContainer container)
        {
        ...
        public static ConsumerSubscriptionConfigurator<TConsumer> Consumer<TConsumer>(this SubscriptionBusServiceConfigurator configurator, IContainer kernel)
        ...
        public static SagaSubscriptionConfigurator<TSaga> Saga<TSaga>(this SubscriptionBusServiceConfigurator configurator, IContainer container)
